...
export default {
  ...
  hosting: {
    ...
    stationModeNote: "工作站模式：任何本地会话结束几秒后，托管会自动恢复。",
    inactive: "当前未在托管 — 本地会话正在使用机械臂，或托管已停止。",
    phaseLabel: "机械臂",
    phase: {
      parked: "已停放",
      engaging: "正在接入…",
  ...
  remoteTeleop: {
    ...
    stationsEmpty: "目前没有工作站在托管。请用 makermodslab --sfu --host <robot> 启动一个，然后刷新。",
    hostingRobot: "正在托管 {{robot}}",
    armMismatch: "机械臂系列不同",
    rowParked: "已停放",
    rowEngagedBy: "{{operator}} 正在驱动",
    seatTaken: "其他人正在驱动",
    start: "开始",
    starting: "正在启动…",
    stop: "停止",
    home: "归位",
    homeHint: "让工作站的机械臂停放到休息位置并保持。",
    engage: "接入",
    engageHint: "以软启动方式重新给工作站的机械臂上电。",
    stationPhaseLabel: "工作站机械臂",
    stationPhase: {
      parked: "已停放",
      engaging: "正在接入…",
      engaged: "已接入",
